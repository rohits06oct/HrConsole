...
public class DataProviderClass {
    ...
    /**
     * Data providers for Hourly Employee
     * Give all values to without rate constructor
     */
    @DataProvider(name = "hourlyEmployeeClassWithoutRate")
    public static Object[][] dataHourlyEmployeeClassWithoutRate() {
        return new Object[][]{{0, "", "Kumar", hireDate, EmployeeType.Hourly, 11000}, {423, "Kanta", "Raj", hireDate, EmployeeType.Hourly, 11000}};
    }

    /**
     * Data providers for Hourly Employee
     * Give all values to with rate constructor
     */
    @DataProvider(name = "hourlyEmployeeClassWithRate")
    public static Object[][] dataHourlyEmployeeClassWithRate() {
        return new Object[][]{{232, "Brajesh", "Kumar", hireDate, 0, EmployeeType.Hourly, 25300}, {893, "Kanta", "Raj", hireDate, 600, EmployeeType.Hourly, 66000}};
    }

    /**
     * Data providers for Salaried Employee
     * Give all values to without experience constructor
     */
    @DataProvider(name = "salariedEmployeeClassWithoutExperience")
    public static Object[][] dataSalariedEmployeeClassWithoutRate() {
        return new Object[][]{{0, "Suraj", "Tomar", hireDate, EmployeeType.Salaried, 25000}, {423, "Rahul", "Ojha", hireDate, EmployeeType.Salaried, 25000}};
    }

    /**
     * Data providers for Salaried Employee
     * Give all values to with experience constructor
     */
    @DataProvider(name = "salariedEmployeeClassWithExperience")
    public static Object[][] dataSalariedEmployeeClassWithRate() {
        return new Object[][]{{36, "Suraj", "Tomar", hireDate, 50, EmployeeType.Salaried, 37500}, {100, "Rahul", "Ojha", hireDate, 4, EmployeeType.Salaried, 35000}};
    }

    /**
     * Data providers for addEmployee
     * Give all values to Hourly Employee constructor with rate
     */
    ...
    /**
     * Data providers for addEmployee
     * Give all values to Hourly Employee constructor withOut rate
     */
    ...
    /**
     * Data providers for addEmployee
     * Give all values to Salaried Employee constructor with experience
     */
    ...
    /**
     * Data providers for addEmployee
     * Give all values to Salaried Employee constructor withOut experience
     */
